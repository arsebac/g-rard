...
Shared mechanism (local build on the Pi, `/deploy`, machine-wide lock, MCP
equivalent `project_redeploy`) documented in `/home/duck/projets/CLAUDE.md`
(French). Here: npm workspaces + Prisma generate, healthcheck
`http://gerard.local/api/health`.
